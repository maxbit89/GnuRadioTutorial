...
# Title: Top Block
# Generated: Wed Apr 17 23:18:11 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.amplitude = amplitude = 5

        ##################################################
        # Blocks
        ##################################################
        self._frequency_range = Range(1, 1600, 1, 50, 200)
        self._frequency_win = RangeWidget(self._frequency_range, self.set_frequency, "frequency", "dial", float)
        ...
        self._amplitude_range = Range(1, 15, 1, 5, 200)
        self._amplitude_win = RangeWidget(self._amplitude_range, self.set_amplitude, "amplitude", "dial", float)
